 ...
 */
class EmployeeAdapter(val mCtx : Context , val layoutId:Int , val employeeList:List<info>)
    :ArrayAdapter<info>(mCtx,layoutId,employeeList){
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val department = view.findViewById<TextView>(R.id.Departmenttext)
    ...
    private  fun updateInfo(employee:info){
